...
const TestimonialsAvatars = ({ priority }: { priority?: boolean }) => {
  return (
    <div className="flex flex-col md:flex-row bg-base-100 p-4 rounded-md justify-center items-center md:items-start gap-3">
      {/* AVATARS */}
      ...
      <div className="flex flex-col justify-center items-center md:items-start gap-1">
        ...
        <div className="text-base text-base-content/80">
          <span className="font-semibold text-base-content">32</span> happy costumers</div>
      </div>
    </div>
  );
};
